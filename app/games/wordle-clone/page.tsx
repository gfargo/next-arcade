...
const WORD_LENGTH = 5
const MAX_GUESSES = 6
const WORDS = ["REACT", "GAMES", "CLONE", "GUESS", "WORDS", "PIXEL", "RETRO", "ARCADE", "CODER", "LOGIC"]
...
export default function WordleClone() {
  ...
  const renderGuess = (guess: string, isCurrentGuess = false) => {
    ...
    for (let i = 0; i < WORD_LENGTH; i++) {
      ...
      let className = "w-12 h-12 border border-green-500 flex items-center justify-center text-2xl"
